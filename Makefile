...
VOBJ=$(VSRC) $(GEN) outputparser/Source_generic_main.ml Input_equiv_verible.ml
...
Source_verible: $(VOBJ)
	ocamlfind ocamlopt -package msat,hardcaml,hardcaml_circuits,unix -linkpkg -g -o $@ -I +unix -I outputparser $(VOBJ)
