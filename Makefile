...
Input_remapp: dump_types.mli Input.ml Input_types.mli ord_input.ml Input_lex.ml Input_scan.ml Input_pp.ml Input_rewrite.ml Input_remapp.ml Input_pat.ml Input_pat2.ml Input_pat3.ml Input_pat4.ml Input_dump.ml # apb_uart_top.ml sample.ml uitms.ml tmp.ml
	ocamlfind ocamlmktop -g -o $@  -package base,hardcaml,hardcaml_waveterm,hardcaml_circuits -linkpkg dump_types.mli Input.mli Input_types.mli Input.ml ord_input.ml Input_lex.ml Input_scan.ml Input_pp.ml Input_rewrite.ml Input_remapp.ml Input_pat.ml Input_pat2.ml Input_pat3.ml Input_dump.ml Input_pat4.ml # apb_uart_top.ml sample.ml uitms.ml tmp.ml
