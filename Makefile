...
Input_dump_top: dump_types.mli Input.ml Input_types.mli ord_input.ml Input_lex.ml Input_pat4.ml rtl_parser.mli rtl_parser.ml rtl_lexer.ml rtl_dump.ml Input_hardcaml.ml Input_dump.ml Input_equiv.ml # apb_uart_top.ml sample.ml uitms.ml tmp.ml  Input_rewrite.ml Input_remapp.ml Input_pat.ml Input_pat2.ml Input_pat3.ml
...
Input_dump: dump_types.mli Input.ml Input_types.mli ord_input.ml Input_lex.ml Input_pat4.ml rtl_parser.mli rtl_parser.ml rtl_lexer.ml rtl_dump.ml Input_hardcaml.ml Input_dump.ml Input_equiv.ml # apb_uart_top.ml sample.ml uitms.ml tmp.ml  Input_rewrite.ml Input_remapp.ml Input_pat.ml Input_pat2.ml Input_pat3.ml
