verilator --top ariane_testharness --lint-only \
-Wno-ascrange -Wno-widthconcat \
-Wno-widthtrunc -Wno-widthexpand -Wno-cmpconst -Wno-unsigned \
-Wno-blkandnblk -Wno-unoptflat -Wno-latch -Wno-caseincomplete \
